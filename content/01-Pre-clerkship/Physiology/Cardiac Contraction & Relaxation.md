...
> **Companion pages:** [[Heart Failure|Heart Failure — Pathophysiology & Approach]] · [[HFrEF|HFrEF]] · [[HFpEF|HFpEF]] · [[HCM|Hypertrophic Cardiomyopathy]] · [[DCM (Dilated Cardiomyopathy)|DCM]] · [[Heart Failure Devices|Devices for Monitoring & Managing Heart Failure]]
> 
...
- **Cardiac Contractility Modulation (CCM)** — ส่งกระแสไฟในช่วง **absolute refractory period** จึงไม่กระตุ้น action potential ใหม่ แต่เพิ่มการทำงานของ **SERCA2a** และการนำแคลเซียมเข้าเซลล์ (ดูเพจ [[Heart Failure Devices|Devices for Monitoring & Managing Heart Failure]])
...
> - **Dobutamine + chronic beta-blocker** — β1 ถูก block อยู่ dobutamine จึงออกฤทธิ์ได้ลดลง — เลือก **PDE3 inhibitor (milrinone)** หรือ **levosimendan** แทน เพราะออกฤทธิ์ **ใต้ต่อ β-receptor** จึงไม่ถูก block — *การเลือก inotrope ในภาวะเฉียบพลัน → เพจ* [[ADHF|ADHF]]
> 
