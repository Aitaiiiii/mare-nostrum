---
title: "Truncus Arteriosus — SNC-Ped D5"
aliases: ["Truncus Arteriosus — SNC-Ped D5", "Truncus Arteriosus"]
stage: Clerkship
rotation: "Pediatrics"
...
created: 2026-08-29
notion_id: 3cb224ab-ad81-81c2-af55-e254025b2c98
...
| Type | ลักษณะ |
| --- | --- |
| I | มี main pulmonary trunk สั้น ๆ ออกจาก truncal root แล้วแยกเป็น branch PA สองข้าง |
| II | Branch PA ออกแยกกัน แต่จากตำแหน่งใกล้กันที่ posterior ของ truncal root |
| III | Branch PA ออกแยกกันชัดเจน จากด้าน lateral ของ truncal root |
| IV | Branch PA ออกจาก descending aorta — ปัจจุบันจัดเป็นรูปแบบหนึ่งของ pulmonary atresia ไม่ใช่ truncus ที่แท้ |
