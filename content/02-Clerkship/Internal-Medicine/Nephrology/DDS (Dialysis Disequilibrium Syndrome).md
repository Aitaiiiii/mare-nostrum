...
tags: []
created: 2026-06-26
notion_id: 38b224ab-ad81-81f1-bcbe-d409127c8afc
...
| --- | --- |
| **Dialysis-related** | First HD session, missed multiple sessions, abrupt ↑ efficiency |
| **Biochemical** | Pre-dialysis BUN ≥ 170–200 mg/dL (≥ 60 mmol/L), hyperglycemia, hypernatremia |
| **Neurologic** | Pre-existing stroke, seizure disorder, malignant HTN, head trauma |
| **Organ-related** | Hepatic failure, hepatic encephalopathy |
| **Demographics** | Pediatric, elderly, small body mass |
| **BBB disruption** | Encephalitis, meningitis, HUS, TTP, vasculitis, sepsis |
...
| --- | --- |
| **Uremic encephalopathy** | Pre-dialysis symptoms, ไม่ worsen ระหว่าง HD |
| **Stroke / ICH** | Focal neurologic deficit, CT diagnostic |
| **Subdural hematoma** | Falls Hx, anticoagulation ใน HD patients |
| **Hyponatremia** | Serum Na < 130 mEq/L |
| **Hypoglycemia** | Glucose < 60 mg/dL; rapid response to dextrose |
| **Drug-induced encephalopathy** | Accumulation ของ renally-cleared drugs |
| **Wernicke's encephalopathy** | Thiamine deficiency: ophthalmoplegia + ataxia + confusion |
| **Meningitis/Encephalitis** | Fever, nuchal rigidity, CSF analysis |
| **Hypertensive emergency** | BP > 180/120, papilledema |
