---
title: "Approach: Vertigo & Dizziness (Timing-and-Triggers — AVS · s-EVS · t-EVS)"
aliases: ["Approach: Vertigo & Dizziness (Timing-and-Triggers — AVS · s-EVS · t-EVS)", "Approach: Vertigo & Dizziness (Timing-and-Triggers"]
stage: Clerkship
...
| --- | --- | --- |
| **H**ead impulse test | มี catch-up saccade (abnormal) | ไม่มี saccade (normal) |
| **N**ystagmus | Unidirectional horizontal ตีออกทางเดียว เพิ่มขึ้นเมื่อมองไปทาง fast phase | Direction-changing เมื่อมองเหลือบซ้ายขวา หรือ vertical/torsional |
| **T**est of **S**kew (alternate cover test) | ไม่มี vertical refixation | มี vertical skew (พบราว 17% สัมพันธ์กับ brainstem lesion) |
...
**Vestibular migraine** — รักษาตามหลักการของ migraine ทั้ง acute และ preventive ดูรายละเอียดที่ [Headache](Headache%2038d224abad8181d582b1fc611bb7c3e9.md)
