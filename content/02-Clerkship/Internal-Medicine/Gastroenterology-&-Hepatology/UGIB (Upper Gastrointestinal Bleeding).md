...
> 🔗 **Order set เต็ม (actionable, หน้างาน — dose/route/freq + variceal vs non-variceal):** [UGIB Standing Order](https://app.notion.com/p/UGIB-321224abad81805b8496df854dea4e76?pvs=21)
> 
...
| **AIMS65** | **A**lbumin <3, **I**NR >1.5, altered **M**S, **S**BP ≤90, age ≥**65** | ≥2 = in-hospital mortality สูง |
...
> 🔗 **Order actionable ทั้งชุดที่:** [UGIB Standing Order](https://app.notion.com/p/UGIB-321224abad81805b8496df854dea4e76?pvs=21) — ส่วนนี้อธิบายเฉพาะหลักการ (RULE 2: link ไม่เขียน order ซ้ำ)
> 
...
- **Variceal**: octreotide + ceftriaxone **ทันที**ก่อนส่องกล้อง (ATB = standard)
