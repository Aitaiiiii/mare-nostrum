...
$\text{MELD} = 3.78\ln(\text{T.Bil}) + 11.2\ln(\text{INR}) + 9.57\ln(\text{Cr}) + 6.43$
...
$\text{MELD 3.0} = 4.56\ln(\text{T.Bil}) + 0.82(137-\text{Na}) - 0.24(137-\text{Na})\ln(\text{T.Bil}) + 9.09\ln(\text{INR}) + 11.14\ln(\text{Cr}) + 1.85(3.5-\text{Alb}) - 1.83(3.5-\text{Alb})\ln(\text{Cr}) + \textbf{1.33 (female)} + 7$
