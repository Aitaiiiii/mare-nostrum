---
title: "Common Arthritis (Gout, Crystal & Approach)"
aliases: ["Common Arthritis (Gout, Crystal & Approach)"]
stage: Clerkship
...
tags: []
created: 2026-06-29
notion_id: 38d224ab-ad81-817d-8eb4-e53328b37f76
...
1. **Colchicine** — คนปกติ (ตับไตดี): 1.2 mg → 0.6 mg 1 ชม.ต่อมา (anti-inflammatory dose). ปรับลดถ้า GFR <50, ระวัง **strong CYP3A4/P-gp inhibitor** (azole, clarithromycin, PI) — ลดโดส/เว้นระยะ (ถ้าให้ 1 mg → repeat ที่ 3 วัน)
2. **NSAIDs** — full dose (ระวัง renal/GI/CV)
3. **Glucocorticoid** — เมื่อ 1–2 ตัวแรกใช้ไม่ได้/มีข้อห้าม: PO/IV systemic — หรือ intra-articular (ถ้า 1–2 ข้อใหญ่ เข่า/ankle)
...
- [ACR 2020 Gout Guideline](https://www.rheumatology.org/Portals/0/Files/Gout-Guideline-Summary.pdf)
- [MSU vs CPPD Crystals (PMC)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6557274/)
