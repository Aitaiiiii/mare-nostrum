...
**RSBI (f/V_T)** — เป็นเพียง monitoring parameter ระหว่าง SBT ไม่ใช่ gatekeeper ก่อน (AARC 2024) — รายละเอียดสูตร, threshold, D-RSBI และ evidence → [[ETT Weaning|ETT Weaning]]
