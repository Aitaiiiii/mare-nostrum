...
> **Shape E (Drug/Class)** — เพจนี้ครอบ beta blocker ข้ามโรค (HFrEF, post-MI, AF, HTN, angina); รายละเอียด dosing/uptitration เฉพาะ HFrEF → ดู [[HFrEF]] · post-MI reversal → ดู [[Post-MI Management]]
> 
...
- **HFrEF (LVEF ≤40%)** — Class 1 (2022 AHA/ACC/HFSA, 2021 ESC HF) เป็นหนึ่งใน foundational pillar เฉพาะ 3 ตัวที่มี mortality evidence: **carvedilol, bisoprolol, metoprolol succinate**; nebivolol เพิ่มได้ในผู้สูงอายุ (SENIORS) → dosing/uptitration ดู [[HFrEF]]
- **Post-MI + LVEF ≤40%** — Class 1 ยังคงเดิม กลุ่มนี้ได้ประโยชน์ชัดเจน
- **Post-MI + LVEF ≥50%** — หลักฐาน 2024–25 พลิกคำแนะนำเดิม (ดู STRICT AVOIDANCE + [[Post-MI Management]])
