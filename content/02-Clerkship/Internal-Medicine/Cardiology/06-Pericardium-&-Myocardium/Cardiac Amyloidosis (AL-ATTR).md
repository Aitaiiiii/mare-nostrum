---
title: "Cardiac Amyloidosis (AL/ATTR)"
aliases: ["Cardiac Amyloidosis (AL/ATTR)"]
stage: Clerkship
...
**Cardiac amyloidosis** เป็นโรคที่**ถูกมองข้ามบ่อยที่สุด** ในผู้ป่วยสูงอายุที่มาด้วย **HFpEF** ร่วมกับผนังหัวใจหนา (**LV hypertrophy**) โดยไม่มีประวัติความดันโลหิตสูงรุนแรง แบ่งเป็นสองกลุ่มหลักที่**ต้องแยกให้ได้เพราะการรักษาต่างกันสิ้นเชิง**:
...
- **Wild-type ATTR (ATTRwt)** — เดิมเรียก senile systemic amyloidosis — พบใน**ชายสูงอายุ** มักมีประวัติ **carpal tunnel syndrome สองข้าง** หรือ **lumbar spinal stenosis** นำมาหลายปี
...
กลไกที่ bone tracer จับกับ ATTR คือ amyloid fibrils ของ ATTR สะสมร่วมกับ**แคลเซียมใน interstitial space** ส่งผลให้สารเภสัชรังสีไปจับกับโครงสร้างดังกล่าว เกิด uptake ที่หัวใจชัดเจนกว่ากระดูก
...
**เกณฑ์วินิจฉัย ATTR-CM โดยไม่ต้องทำ biopsy** — ต้องครบ**ทั้งสองข้อพร้อมกัน**:

1. **Perugini grade 2 หรือ 3** myocardial uptake
2. **Monoclonal protein screen เป็นลบ (negative) ทั้ง 3 อย่าง**
...
ณ ปัจจุบัน FDA อนุมัติ **3 disease-directed therapies** ซึ่งมีเป้าที่ TTR เหมือนกันแต่**ต่างกลไกกัน**:
...
**หลักการเลือกยา:** tafamidis หรือ acoramidis เป็น first-line ใน **NYHA class I–III**; vutrisiran เป็นทางเลือกใน NYHA I–III โดย magnitude of benefit ดู**สม่ำเสมอข้าม NYHA class** — *บทบาทของ* **combination therapy ยังไม่ชัด** *เนื่องจาก ATTRibute-CM และ HELIOS-B อนุญาตให้ใช้ tafamidis ร่วมได้ แต่***ไม่ได้ออกแบบมาเพื่อเปรียบ monotherapy vs combination**
...
- **Fibril depleters** — **ALXN2220**, **coramitug** — (monoclonal antibody) — กำจัด amyloid ที่**สะสมไปแล้ว** — *ต่างจาก stabilizer/silencer ที่เพียงหยุดการสะสมเพิ่ม*
