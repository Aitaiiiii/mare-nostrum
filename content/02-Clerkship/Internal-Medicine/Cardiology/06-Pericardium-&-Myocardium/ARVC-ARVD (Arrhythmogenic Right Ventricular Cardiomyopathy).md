---
title: "ARVC/ARVD (Arrhythmogenic Right Ventricular Cardiomyopathy)"
aliases: ["ARVC/ARVD (Arrhythmogenic Right Ventricular Cardiomyopathy)"]
stage: Clerkship
...
created: 2026-07-21
notion_id: 3a4224ab-ad81-81b8-897b-ec4770d9a069
...
1. **Global/regional dysfunction** — echo/MRI/RV angiography (regional RV akinesia/dyskinesia/aneurysm + เกณฑ์ RVOT/RVEDV/RVEF)
2. **Tissue characterization** — residual myocytes **<60%** + fibrous±fatty [major]; 60–75% [minor]
3. **Repolarization** — TWI V1–V3 [major]
4. **Depolarization/conduction** — epsilon wave [major]; late potentials/TAD ≥55 ms [minor]
5. **Arrhythmias** — NSVT/VT **LBBB morphology + superior axis** [major]; RVOT config LBBB inferior axis หรือ >500 PVC/24h [minor]
6. **Family history** — confirmed ARVC/pathogenic mutation ใน 1st-degree relative [major]
