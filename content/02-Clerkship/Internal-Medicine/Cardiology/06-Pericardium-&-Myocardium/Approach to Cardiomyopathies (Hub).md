---
title: "Approach to Cardiomyopathies (Hub)"
aliases: ["Approach to Cardiomyopathies (Hub)"]
stage: Clerkship
...
> **ประเด็นสำคัญ**: Hub นี้**ทำหน้าที่นำทาง (routing) เท่านั้น** — ไม่ duplicate เนื้อหาของ spoke เอง สำหรับกลไกเชิงลึก, เกณฑ์การวินิจฉัยเต็มรูปแบบ, และยา/เครื่องมือ ให้เปิดเข้า spoke ที่เกี่ยวข้อง
> 
