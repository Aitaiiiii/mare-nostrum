---
title: "Acute Pericarditis — Diagnostic Criteria, NSAID/Colchicine Order Set & Admission Triage"
aliases: ["Acute Pericarditis — Diagnostic Criteria, NSAID/Colchicine Order Set & Admission Triage", "Acute Pericarditis"]
stage: Clerkship
...
| Criteria | Phenotype | Mechanism |
| --- | --- | --- |
| Pericarditic chest pain | Pleuritic, เพิ่มขณะไอ/หายใจเข้า, ทุเลาขณะโน้มตัวไปข้างหน้า | ลดการกดทับ phrenic nerve |
| Pericardial friction rub | High-pitched, ชัดที่ left sternal border | เสียดสีกันของชั้นมี fibrin |
| New widespread ST-elevation/PR depression | Concave-up ST, เว้น aVR/V1 | Superficial epicardial current of injury |
| Pericardial effusion (new/↑) | จาก echo | Exudative leak |
...
| --- | --- | --- |
| High fever | > 38.0°C | Systemic response รุนแรง/purulent |
| Subacute onset | หลายสัปดาห์ | Non-viral etiology (TB, neoplastic) |
| Large effusion | > 20 mm diastole | เสี่ยง tamponade — ดู [[Cardiac Tamponade]] |
| Cardiac tamponade | Diastolic RV collapse | ดู [[Cardiac Tamponade]] |
| Failure of therapy | ไม่ดีขึ้นหลัง NSAIDs ≥ 7 วัน | Refractory/immunocompromised |
...
> 🇹🇭 **Thai availability:** Anakinra/Rilonacept ยังไม่มีข้อมูลยืนยันการขึ้นทะเบียน/การเข้าถึงในระบบราชการไทย (need confirm) — อย่าสมมติว่าเข้าถึงได้เหมือน US; **NSAID/colchicine/steroid มีใช้ทั่วไปใน [รพ.ไทย](http://รพ.ไทย)**
> 
