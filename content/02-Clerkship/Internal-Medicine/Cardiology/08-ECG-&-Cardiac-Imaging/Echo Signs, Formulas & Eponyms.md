...
> หน้านี้เป็นเพจที่ 4 ของ eponym/reference series — คู่กับ [[ECG & EP Eponyms]], [[CV Physical Exam Eponyms]] และ [[Cardiac Procedure Names & Eponyms|Cardiac Surgery & Intervention Procedures (CVT / Cardiac Surgery / Structural — Eponymous & Common Names)]] — รวบรวม **ชื่อ formula, sign, pattern และ parameter ทาง echocardiography** ทั้ง eponym และชื่อ common จัดหมวด: Formulas/Doppler → Named signs → M-mode signs → Chamber/function parameters → Named anatomy → Modalities/artifacts
> 

> ⚙️ routing: quantification ของโรคเฉพาะอยู่ที่เพจโรคนั้นๆ — PHT/continuity ของ MS → [[Mitral Stenosis]] · respiratory Doppler variation → [[Cardiac Tamponade]] · diastolic function (E/e′, LAVi) → [[HFpEF]] · valve severity → [[Valvular Heart Disease]]
> 
...
| **Pressure half-time (MVA, Hatle)** | **MVA = 220 / PHT** (220 = empirical constant ของ Hatle 1979) | PHT = เวลาจาก Vmax → Vmax/1.4; **overestimate severity ใน diastolic dysfunction, underestimate เมื่อมี AR**; ไม่ reliable ทันทีหลัง PMBC → [[Mitral Stenosis]] |
...
> ค่าเหล่านี้เปลี่ยนตาม guideline edition — โดยเฉพาะ **2025 ASE** ปรับ TAPSE/diastolic algorithm; ดู [[HFpEF]] สำหรับ diastolic function algorithm ฉบับเต็ม
> 
...
- **Wilkins (Wilkins-Block) score** — 16-point echo score ทำนายความสำเร็จของ **percutaneous mitral balloon valvuloplasty (PMBC)**: 4 องค์ประกอบ — **leaflet mobility, leaflet thickening, subvalvular thickening, calcification** (แต่ละข้อให้ 1-4 คะแนน รวม 4-16); **≤ɒ8 คะแนน = favorable anatomy** (PMBC สำเร็จสูง), 9-11 = intermediate, **>11 = poor candidate** (สูงต่อ complication) — ดู [[Mitral Stenosis]] สำหรับ decision algorithm เต็ม (✅ verified)
