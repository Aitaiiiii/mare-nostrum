---
title: "Key Investigations in Cardiology"
aliases: ["Key Investigations in Cardiology"]
stage: Clerkship
...
| ประเภท | Osmolality (mOsm/kg) | ตัวอย่าง |
| --- | --- | --- |
| High-osmolality (ionic monomer) | &gt;1500 — obsolete แล้ว | diatrizoate, iothalamate |
| Low-osmolality (ionic dimer) | ~600 | ioxaglate |
| Low-osmolality (nonionic monomer) | 500–850 | iohexol, iopamidol, ioversol, iopromide, iomeprol |
...
| ความรุนแรง | อาการ | การรักษา |
| --- | --- | --- |
| **Mild** | Urticaria/itching จำกัดบริเวณ, mild nausea | Diphenhydramine 25–50 mg IV/PO มักพอ |
| **Moderate** | Urticaria กระจายทั่ว, mild bronchospasm, hypotension ที่ตอบสนองต่อ IV fluid | Diphenhydramine + O₂; ถ้าไม่มี hypotension ชัดเจนให้ **epinephrine IM 0.3 mL ของ 1:1000 (0.3 mg) ซ้ำได้ทุก 10–15 นาที จนถึง 1 mg รวม**; bronchospasm เสริม albuterol; cimetidine/ranitidine เป็น adjunct |
| **Severe** | Laryngeal edema, profound hypotension, anaphylactic shock, cardiopulmonary arrest | Epinephrine IV infusion, secure airway (call anesthesia), large-volume NS 1–3 L ชั่วโมงแรก, hydrocortisone, O₂/ABG monitoring, เตรียม ACLS |
...
| Modality | Resolution | จุดเด่น |
| --- | --- | --- |
| Coronary CTA | ~600 μm | Non-invasive, ดู plaque burden ภาพรวม |
| Invasive angiography | ~200 μm | Luminogram เท่านั้น ไม่เห็นผนังหลอดเลือด |
| IVUS | ~100 μm | เห็นผนังหลอดเลือดทั้งชั้น, วัด plaque burden/vessel size ได้ดี, penetration ลึกกว่า OCT |
...
| สงสัยสาเหตุ | Non-invasive | Invasive |
| --- | --- | --- |
| Myocarditis | TTE (effusion), CMR (myocarditis/pericarditis pattern) | Endomyocardial biopsy |
...
| Pulmonary embolism | D-dimer, CT pulmonary angiogram, thrombophilia screen | — |
