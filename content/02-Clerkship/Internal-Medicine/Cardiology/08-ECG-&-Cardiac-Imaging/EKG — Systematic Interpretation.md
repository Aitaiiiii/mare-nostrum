---
title: "EKG — Systematic Interpretation"
aliases: ["EKG — Systematic Interpretation", "EKG"]
stage: Clerkship
...
> กฎทองคำ: **aVF ต้องเป็นบวกเสมอ**ใน normal placement — ถ้าผิดปกติให้สงสัย lead reversal ก่อนตีความ axis/arrhythmia
> 
...
- Perimyocarditis: TWI เกิด**หลัง** STE กลับสู่ baseline แล้ว มักพบหลาย lead
...
- 🔍 Verification status
    ...
    **✅ Searched & verified (28 ก.ค. 2026)**
    ...
    - Pathologic Q wave (≥40ms กว้าง, ≥2mm หรือ ≥25% QRS ลึก, ≥2 contiguous leads) — StatPearls, EMCrit IBCC, [ecglectures.com](http://ecglectures.com)
    - QTc prolonged ≥450ms ชาย/≥460ms หญิง, short <390ms, >500ms torsades risk — 2009 AHA/ACCF/HRS Recommendations (Circulation)
    - RAE (P lead II ≥2.5mm, V1/V2 ≥1.5mm), LAE (P lead II >120ms) — LITFL, ScienceDirect, [ecgwaves.com](http://ecgwaves.com)
    ...
    **⚠️ From source, not individually re-verified this session**
    ...
    - RV infarction PPV~100%/NPV~80% ตัวเลขเฉพาะ
