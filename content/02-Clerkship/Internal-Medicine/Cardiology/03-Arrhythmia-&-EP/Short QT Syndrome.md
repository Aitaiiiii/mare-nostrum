...
| Type | Gene / current | Mechanism | ลักษณะเฉพาะ |
| --- | --- | --- | --- |
| **SQT1** | KCNH2 (Kv11.1/HERG) / ↑IKr | Gain-of-function | พบบ่อยที่สุด |
| **SQT2** | KCNQ1 (Kv7.1) / ↑IKs | Gain-of-function | - |
| **SQT3** | KCNJ2 (Kir2.1) / ↑IK1 | Gain-of-function | **Asymmetric T wave** ที่จำเพาะ (tall, peaked, asymmetric ascending/descending limb) |
| **SQT4–6** | CACNA1C / CACNB2 / CACNA2D1 | **Loss-of-function ของ L-type Ca²⁺ channel** (ตรงข้ามกับ SQT1-3) | Overlap phenotype กับ **Brugada syndrome** (short QT + Brugada ECG pattern ร่วมกัน) |
...
> ⚠️ **Historical note:** เกณฑ์ก่อนหน้านี้ (Gollob 2011 point-based score, และ EHRA consensus ที่เคยเสนอ QTc ≤ 330 ms) ถูก**แทนที่**ด้วยเกณฑ์ 2022 ESC ข้างต้น — หากพบ reference เก่าที่ระบุ QTc ≤330/≤340 แยกกันตาม EHRA/ESC (ดังใน source เอกสาร SNC4) ให้ยึดเกณฑ์ 2022 ESC เป็นหลักเนื่องจากเป็น guideline ปัจจุบันที่ verify แล้ว
> 
...
- **Cardiac arrest survivor หรือ documented sustained VT/VF** → **ICD (Class I)** หาก life expectancy > 1 ปี — เป็น primary means ในการป้องกัน SCD
...
- **VT/VF electrical storm** → **isoproterenol (Class IIa)** เพิ่ม ICaL current ช่วยยืด AP duration ชั่วคราว
- **Genetic testing/family screening** — **Class IIb**: เสนอให้ first-degree relatives แม้ยังไม่มีอาการ เนื่องจาก AD inheritance pattern และ variable penetrance
