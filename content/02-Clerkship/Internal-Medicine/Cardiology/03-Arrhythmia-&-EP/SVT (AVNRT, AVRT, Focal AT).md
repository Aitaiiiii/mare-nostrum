---
title: "SVT — AVNRT / AVRT / Focal AT (Regular Narrow-Complex Reentrant & Focal Mechanisms)"
aliases: ["SVT — AVNRT / AVRT / Focal AT (Regular Narrow-Complex Reentrant & Focal Mechanisms)", "SVT", "SVT — AVNRT - AVRT - Focal AT (Regular Narrow-Complex Reentrant & Focal Mechanisms)"]
stage: Clerkship
...
| Feature | Typical AVNRT | Orthodromic AVRT | Focal AT |
| --- | --- | --- | --- |
| **Mechanism** | Dual AV nodal reentry | AV node + accessory pathway | Ectopic atrial focus |
| **RP relationship** | Very short RP (P ซ่อนใน QRS) | Short RP (RP < ½ RR, P หลัง QRS) | Long RP (P ก่อน QRS ถัดไป) |
| **Pathognomonic ECG** | Pseudo-r′ ใน V1, pseudo-S ใน II/III/aVF | ST depression, QRS/T alternans | P morphology ≠ sinus |
| **VA interval (EPS)** | ≤ 70 ms | > 70 ms | แปรผัน |
| **Response to AV block** | Terminate | Terminate | Continue |
| **Onset** | APC, sudden | APC/VPC | Warm-up |
