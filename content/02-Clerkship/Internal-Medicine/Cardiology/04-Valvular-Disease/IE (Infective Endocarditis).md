...
type: "Disease"
guidelines: ["ACC/AHA", "ESC", "IDSA"]
review_status: "New"
tags: [cardiology, valvular-disease, disease, acc-aha, esc, idsa]
created: 2026-07-18
...
1. ทำลาย leaflet หรือ chordae จนเกิด regurgitation เฉียบพลัน → acute heart failure
2. ลุกลามออกนอก annulus → abscess, pseudoaneurysm, fistula, new AV block
3. หลุดเป็น septic embolus → stroke, splenic infarct, mycotic aneurysm และ septic pulmonary embolism ใน right-sided IE
...
1. **ได้ antibiotic ไปก่อนเจาะ** — สาเหตุที่พบบ่อยที่สุด แก้ได้ด้วยการเจาะก่อนให้ยาเสมอ และเจาะซ้ำหลังหยุดยาหลายวันในรายที่ยังสงสัย
2. **เชื้อ fastidious หรือ intracellular** — Coxiella burnetii เป็นตัวนำที่ 46% ถึง 61% ของ BCNE ที่หาเชื้อได้ ตามด้วย Bartonella ที่ 15% ถึง 21% · ที่เหลือคือ Brucella, Tropheryma whipplei, Legionella, Mycoplasma, nutritionally variant streptococci และเชื้อรา
3. **ไม่ได้เกิดจากเชื้อ** — NBTE และ Libman-Sacks endocarditis ซึ่งอยู่ในหัวข้อ DDx
