---
title: "MR (Mitral Regurgitation) — Primary vs Secondary, COAPT/MITRA-FR & 2025 ESC Algorithm"
aliases: ["MR (Mitral Regurgitation) — Primary vs Secondary, COAPT/MITRA-FR & 2025 ESC Algorithm", "MR (Mitral Regurgitation)", "MR", "MR (Mitral Regurgitation) — Primary vs Secondary, COAPT-MITRA-FR & 2025 ESC Algorithm"]
stage: Clerkship
...
tags: []
created: 2026-07-18
notion_id: 3a0224ab-ad81-81f5-980e-d4b8686fd0f9
...
> **Source:** Digest จาก teaching-log (fellowship cardiology) + live search (18 ก.ค. 2026). Companion ของ [[Valvular Heart Disease]] board-review page. สำหรับ M-TEER device/procedural details → ดู [[Transcatheter Mitral-Tricuspid Therapy]] แยก
> 
...
| --- | --- | --- |
| **Primary (Organic)** | Degenerative (myxomatous/Barlow's, fibroelastic deficiency), rheumatic, IE | Leaflet/chordae เสียหายโดยตรง → prolapse/flail → failure of coaptation |
...
- **MVP** → **mid-systolic click** ก่อน murmur; maneuver ที่ลด preload (standing, Valsalva) → click มาเร็วขึ้นและ murmur ยาวขึ้น (ต่างจาก HCM ที่ murmur ดังขึ้นเช่นกันแต่กลไกต่าง)
...
| Parameter | Severe Primary MR | Severe Secondary MR | Rationale |
| --- | --- | --- | --- |
| Vena Contracta | ≥ 0.7 cm | ≥ 0.7 cm | ขนาด jet ที่แคบที่สุด |
| EROA (PISA) | ≥ 0.4 cm² | ≥ 0.2–0.3 cm² | Secondary MR รูรั่ว elliptical → PISA underestimate → cutoff ต่ำกว่า |
| Regurgitant Volume | ≥ 60 mL | ≥ 30 mL | Secondary MR เล็กกว่าแต่กระตุ้น HF ได้รุนแรงกว่า (compliance แย่) |
...
| Class | Criteria |
| --- | --- |
| I | Symptomatic severe PMR + LVEF >30% → **surgery (repair เหนือ replacement)** |
...
| **I (ใหม่ 2025) — ต้องมี qualifier** | Asymptomatic severe PMR + LV function ปกติ (LVESD <40, LVEF >60%) **แต่มี ≥ 3 ข้อของ adverse markers: AF, PASP >50 mmHg, LA enlargement, concomitant TR** → repair ใน expert centre เมื่อ durable result likely |
