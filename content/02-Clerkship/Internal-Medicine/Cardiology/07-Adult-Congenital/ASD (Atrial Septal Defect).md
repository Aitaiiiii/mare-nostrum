...
- 🔍 Verification status
    ...
    - เกณฑ์การปิดเมื่อมี PAH เปลี่ยนจาก ratio-based (PASP/SBP, PVR/SVR ของ 2018) เป็น **PVR สัมบูรณ์ ≤2 WU หรือ >2-<5 WU** เข้าใกล้เกณฑ์ ESC มากขึ้น (JACC 2025, [professional.heart.org](http://professional.heart.org) top-things-to-know)
