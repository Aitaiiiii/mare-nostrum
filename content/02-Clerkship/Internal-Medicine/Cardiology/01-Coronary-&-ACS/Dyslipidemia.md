...
- 🔍 Verification status
    ...
    🔴 **Flagged uncertain** — **Bempedoic acid และ inclisiran สถานะทะเบียน/จำหน่ายในไทย**: ยังไม่ยืนยันชัด ต้องเช็ค [อย.ไทย/บริษัทก่อนใช้จริง](http://อย.ไทย/บริษัทก่อนใช้จริง) · SCORE2 category ตัวอย่างผู้ป่วยเป็น approximation ควรเทียบ full ESC risk table
