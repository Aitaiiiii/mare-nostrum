---
title: "Coronary Spasm (Vasospastic Angina)"
aliases: ["Coronary Spasm (Vasospastic Angina)"]
stage: Clerkship
...
1. **Nitrate-responsive angina** ร่วมกับอย่างน้อย 1 ใน: (a) rest angina โดยเฉพาะช่วงดึก/เช้ามืด, (b) marked diurnal variation ของ exercise tolerance, (c) hyperventilation กระตุ้นอาการ, (d) CCB (ไม่ใช่ beta-blocker) ระงับอาการได้
2. **Transient ischemic ECG change** ระหว่างมีอาการจริง ≥2 contiguous leads: STE ≥0.1 mV, STD ≥0.1 mV, หรือ new negative U wave
3. **Documented coronary spasm** — transient occlusion >90% ร่วมกับอาการ+ECG change เกิดขึ้นเอง (spontaneous) หรือจาก provocation test
