---
title: "Preoperative Cardiac Risk Assessment (Non-Cardiac Surgery)"
aliases: ["Preoperative Cardiac Risk Assessment (Non-Cardiac Surgery)"]
stage: Clerkship
...
tags: [workflow]
created: 2026-06-29
notion_id: 38e224ab-ad81-81c2-8a5b-f2f9e657e015
...
1. **Major Adverse Cardiovascular Event (MACE)** — MI, stroke, arrhythmia, **30-day mortality** (เป็น risk อันดับ 1 ที่ guideline โฟกัส)
2. **Bleeding risk** — ขึ้นกับชนิดหัตถการ + antithrombotic ที่คนไข้ใช้
3. **Specific risk อื่น ๆ** ตาม underlying disease — COPD, DM, long-term corticosteroid use (adrenal suppression), CKD
...
1. มี **serious active cardiac symptom?** → ใช่ = postpone + treat → stabilize ก่อน
2. ไม่มี → คำนวณ **calculated risk (RCRI/NSQIP)** + ดู **risk modifiers**
3. **Low calculated risk + ไม่มี modifier** → proceed
4. **Elevated risk, ไม่มี modifier** → พิจารณา ECG → ประเมิน **functional status (METs/DASI)**: ≥4 METs/score ดี → proceed; <4/score ต่ำ → further testing **เฉพาะถ้าผลจะ impact management**
5. **มี risk modifier** → perioperative diagnostic testing (ECG/TTE) + **consult cardiologist**
...
🔗 **Quick links:** [2024 ACC/AHA Perioperative Guideline](https://www.ahajournals.org/doi/10.1161/CIR.0000000000001285) · [RCRI Calculator (MDCalc)](https://www.mdcalc.com/calc/1739/revised-cardiac-risk-index-pre-operative-risk)
