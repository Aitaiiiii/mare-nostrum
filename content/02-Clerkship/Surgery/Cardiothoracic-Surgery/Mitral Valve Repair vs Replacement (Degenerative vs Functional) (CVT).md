---
title: "Mitral Valve Repair vs Replacement (Degenerative vs Functional) (CVT)"
aliases: ["Mitral Valve Repair vs Replacement (Degenerative vs Functional) (CVT)"]
stage: Clerkship
rotation: "Surgery"
...
tags: []
created: 2026-08-04
notion_id: 3b2224ab-ad81-81c5-b77e-e4d21f1172c4
...
**Short Note in CVT — B5 · Ischemic & Valve (SNC-CVT Template B: disease→surgery).** เพจนี้ครอบ **surgical repair technique + repair-vs-replace decision** — degenerative vs functional. MR disease/staging/COAPT-MITRA-FR → [MR (Mitral Regurgitation) — Primary vs Secondary, COAPT/MITRA-FR & 2025 ESC Algorithm](MR%20(Mitral%20Regurgitation)%20%E2%80%94%20Primary%20vs%20Secondary,%20%203a0224abad8181f5980ed4b8686fd0f9.md). Transcatheter (M-TEER) → [Transcatheter Mitral & Tricuspid Therapies — M-TEER, T-TEER & TTVR](Transcatheter%20Mitral%20&%20Tricuspid%20Therapies%20%E2%80%94%20M-TEE%203a0224abad8181879a48c742b224dea1.md).
...
- **อย่า replace degenerative MR ที่ repairable** — repair เหนือกว่าชัด (survival/LV function); ถ้า repair ยาก → refer expertise center ก่อนตัดสิน replace
- **อย่าทำ leaflet repair โดยไม่ใส่ annuloplasty ring** — recurrence สูง (ทั้ง resection, neochordae, Alfieri ต้อง ring เสมอ)
- **อย่าคาดว่า annuloplasty เดี่ยว fix severe ischemic MR ได้ถาวร** — recurrent MR สูง (CTSN: replace durable กว่า); secondary MR เป็นโรค ventricle
- **ระวัง SAM หลัง repair** — โดยเฉพาะ excess posterior leaflet tissue/small LV → LVOT obstruction; ตรวจ intraop TEE
</aside>
...
- **MV = repair ก่อน replace** (degenerative) — gold standard, Class I เมื่อ durable; เก็บ apparatus → LV function ดีกว่า
- **Technique:** annuloplasty ring (ทำเสมอ) + leaflet resection หรือ neochordae (posterior prolapse) + Alfieri edge-to-edge
- **Degenerative** = repairable สูง (โดยเฉพาะ posterior); anterior/bileaflet/calcified → expertise center
- **Functional/secondary** = โรค ventricle; annuloplasty recurrence สูง (CTSN: replace durable กว่าใน severe ischemic MR); guideline ไม่ชี้ขาด
- **Failure:** early = dehiscence/SAM/hemolysis; late = progression/fibrosis
- **Pitfall:** repair ต้องมี ring; SAM จาก excess tissue; secondary MR แก้ valve อย่างเดียวไม่พอ
</aside>
