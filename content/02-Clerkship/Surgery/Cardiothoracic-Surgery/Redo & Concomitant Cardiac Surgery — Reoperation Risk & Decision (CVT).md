---
title: "Redo & Concomitant Cardiac Surgery — Reoperation Risk & Decision (CVT)"
aliases: ["Redo & Concomitant Cardiac Surgery — Reoperation Risk & Decision (CVT)", "Redo & Concomitant Cardiac Surgery"]
stage: Clerkship
rotation: "Surgery"
...
tags: [workflow]
created: 2026-08-04
notion_id: 3b2224ab-ad81-81bc-a90e-f0aa6e819f60
...
**Short Note in CVT — B8 · Ischemic & Valve (SNC-CVT Template C/D: concept/decision).** เพจนี้เป็น cross-cutting concept — redo sternotomy risk + การตัดสินใจ concomitant procedure (เชื่อมกับ B1–B7). CPB strategy → [Cardiopulmonary Bypass (CPB) — Circuit & Physiology (CVT)](Cardiopulmonary%20Bypass%20(CPB)%20%E2%80%94%20Circuit%20&%20Physiolog%203b2224abad81815fb29fd63dfdeec96e.md) (A1). CABG-vs-PCI → [CABG vs PCI — Revascularization Decision (SYNTAX, Heart Team) (CVT)](CABG%20vs%20PCI%20%E2%80%94%20Revascularization%20Decision%20(SYNTAX,%20%203b2224abad81818abe97d26cba08683c.md) (B2).
...
- **อย่า redo sternotomy โดยไม่มี gated CT** — ต้อง map patent graft/great vessel ติด sternum ก่อน; ไม่งั้น injury LIMA-LAD → catastrophic MI
- **อย่าเปิด sternum ก่อน CPB เมื่อ high re-entry risk** — patent graft/pseudoaneurysm ติด sternum → ต้อง early peripheral CPB ก่อน
- **อย่ารอ redo valve จน NYHA IV/emergent** — mortality กระโดดจาก 1.6% → 20–38%; refer ก่อน deteriorate
- **อย่าพ่วง concomitant CABG ใน redo valve โดยไม่ชั่ง risk** — เพิ่ม mortality; พิจารณา PCI coronary แทนถ้าเหมาะ
</aside>
...
- **redo-sternotomy = ช่วงอันตรายที่สุด** — adhesion → graft/RV/great vessel injury; 30-day mortality 2–6× primary
- **Mortality ขึ้นกับ NYHA (1.6%→20.8%) + urgency (elective 1.4% → emergent 37.5%)** — refer ก่อน deteriorate
- **redo CABG = mortality สูงสุด (~4.3%)** — incomplete revasc + conduit จำกัด; มักเลือก PCI
- **Workup:** gated CT map re-entry; **CPB strategy:** early peripheral เมื่อ high-risk anatomy, late เมื่อ low-risk
- **Concomitant:** ทำ significant pathology รวมเลี่ยง reoperation แต่ concomitant CABG เพิ่ม risk → พิจารณา PCI
- **Alternatives:** right thoracotomy, beating-heart TV redo (เลี่ยง LIMA injury), ViV-transcatheter
</aside>
