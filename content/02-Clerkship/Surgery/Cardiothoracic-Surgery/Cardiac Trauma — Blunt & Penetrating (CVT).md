---
title: "Cardiac Trauma — Blunt & Penetrating (CVT)"
aliases: ["Cardiac Trauma — Blunt & Penetrating (CVT)", "Cardiac Trauma"]
stage: Clerkship
rotation: "Surgery"
...
created: 2026-08-05
notion_id: 3b3224ab-ad81-81f6-8a27-f7865e73b3c3
...
**Short Note in CVT — G4 · Emergencies & complications (SNC-CVT Template B/D: trauma).** Cardiac trauma — blunt (BCI, commotio cordis) vs penetrating, ED thoracotomy. Tamponade physiology/drainage → [Cardiac Tamponade](Cardiac%20Tamponade%2038a224abad8181c88c29ef4c4d355967.md). Guidelines อ้าง EAST/trauma (นอก schema) — เว้นว่าง.
...
- **อย่าทำ ED thoracotomy ใน blunt traumatic arrest เป็น routine** — เกือบ fatal เสมอ; ทำเฉพาะ penetrating + signs of life
- **อย่าพลาด commotio cordis → defibrillate ทันที** — VF ในนักกีฬา; delay → survival ตก
- **อย่า discharge BCI ที่ ECG/troponin ผิดปกติ** — monitor arrhythmia/delayed rupture 24–48 ชม.
- **อย่า pericardiocentesis เป็น definitive ใน penetrating tamponade** — clotted hemopericardium → ต้อง surgery (bridge ได้เท่านั้น)
- **อย่าลืม iatrogenic penetrating** (cath/pacemaker/pericardiocentesis) — เป็นสาเหตุ penetrating ที่พบได้
</aside>
...
- **penetrating vs blunt = predictor survival สำคัญสุด**; stab (tamponade, salvageable) > GSW
- **BCI:** contusion→dysrhythmia→rupture; ECG **sinus tachycardia ~80%**; Dx = ECG + troponin + echo; monitor 24–48 ชม.
- **Commotio cordis:** impact 10–30 ms ก่อน T peak → VF; **treatment = defibrillation ทันที**; หัวใจปกติ
- **Penetrating:** FAST (~99% specific effusion); stable+effusion → OR; tamponade (stab) vs exsanguination (GSW)
- **ED thoracotomy:** strong = penetrating thoracic + signs of life; blunt arrest → fatal เกือบเสมอ; left 4th/5th ICS + open pericardium + cross-clamp aorta
- **Pitfall:** อย่า EDT ใน blunt arrest; commotio → defib ทันที
</aside>
