...
**Short Note in CVT — C2 · Aorta (SNC-CVT Template B/D: decision).** เพจนี้ครอบ **management decision ของ Type B dissection** — medical vs TEVAR vs open + operative concept. Aortic syndrome classification/pathophysiology → [[Acute Aortic Syndrome (AAS)]]. Type A → [[Type A Aortic Dissection Surgery]] (C1). BP control acute → [[Hypertensive Crises (Emergency & PSH)]].
