---
title: "Lung Transplantation — Indication, PGD & CLAD (CVT)"
aliases: ["Lung Transplantation — Indication, PGD & CLAD (CVT)", "Lung Transplantation"]
stage: Clerkship
rotation: "Surgery"
...
created: 2026-08-05
notion_id: 3b3224ab-ad81-8104-b8c6-e2b9312556d4
...
**Short Note in CVT — F2 · Transplant & end-stage (SNC-CVT Template B/G: program).** Lung transplantation — indication, bilateral vs single, PGD, CLAD. Heart transplant (immunosuppression/rejection ใช้ร่วมกรอบ) → [Cardiac Transplantation — Candidacy, DCD, Immunosuppression, Rejection & CAV](Cardiac%20Transplantation%20%E2%80%94%20Candidacy,%20DCD,%20Immunosu%2039e224abad8181519444daf5af13d256.md). VA/VV-ECMO (intraop/bridge) → [MCS (Mechanical Circulatory Support) — Durable LVAD & Temporary MCS (IABP · Impella · VA-ECMO)](MCS%20(Mechanical%20Circulatory%20Support)%20%E2%80%94%20Durable%20LVA%2039e224abad8181199a72db36466e851e.md) (MCS). Guidelines อ้าง ISHLT (นอก schema) — เว้นว่างตาม no-forcing.
...
- **อย่า refer lung Tx ช้าใน ILD/IPF** — ดำเนินโรคเร็ว + waitlist mortality สูง; refer เร็วแม้ lung function ยังพอ
- **อย่ามองข้าม esophageal dysmotility ใน scleroderma** — aspiration → CLAD/PGD; ต้องประเมิน + fundoplication/G-J tube
- **อย่าทำ single lung ใน CF/suppurative** — native lung ที่เหลือติดเชื้อ → cross-infect graft; ต้อง bilateral
- **อย่าพลาด PGD ใน 72 ชม.** — severe (grade 3) → ECMO ก่อน graft เสียถาวร; PGD เพิ่ม CLAD ระยะยาว
- **อย่าลืมแยก RAS จาก BOS** — RAS (restrictive + opacities) prognosis แย่กว่ามาก
</aside>
...
- **Lung Tx = survival ต่ำสุดใน solid organ** (median ~6.5 ปี); ตัวกำหนด long-term = CLAD
- **Indication:** ILD (ปัจจุบันอันดับ 1) · COPD · CF · PAH · scleroderma-ILD; allocation LAS→**CAS (2023)**
- **Bilateral predominant** (long-term ดีกว่า); CF/PAH ต้อง bilateral; single → ILD/COPD อายุมาก/donor scarce; intraop VA-ECMO นิยมขึ้น
- **PGD** = 72 ชม., grade 0–3 (PaO₂/FiO₂ + infiltrate), early mortality, เพิ่ม CLAD; severe → ECMO
- **CLAD (2019 ISHLT):** BOS (obstructive, air-trapping) vs **RAS (restrictive, FEV₁≤80%+TLC≤90%, opacities — prognosis แย่สุด)**
- **Pitfall:** scleroderma esophageal dysmotility → aspiration → CLAD; refer ILD เร็ว
</aside>
