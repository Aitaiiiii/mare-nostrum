...
**Short Note in CVT — C5 · Aorta (SNC-CVT Template A/C: procedure).** เพจนี้ครอบ **TAAA repair — Crawford extent + spinal cord protection**. Aneurysm natural history/threshold → [[Acute Aortic Syndrome (AAS)]]. Arch/FET (proximal extension) → [[Aortic Arch Surgery]] (C4). Type B/TEVAR (descending-only) → [[Type B Aortic Dissection]] (C2).
