...
**Short Note in CVT — B8 · Ischemic & Valve (SNC-CVT Template C/D: concept/decision).** เพจนี้เป็น cross-cutting concept — redo sternotomy risk + การตัดสินใจ concomitant procedure (เชื่อมกับ B1–B7). CPB strategy → [[Cardiopulmonary Bypass (CPB)]] (A1). CABG-vs-PCI → [[CABG vs PCI]] (B2).
