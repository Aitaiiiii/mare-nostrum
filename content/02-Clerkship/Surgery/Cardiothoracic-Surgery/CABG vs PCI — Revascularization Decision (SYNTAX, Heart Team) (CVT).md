---
title: "CABG vs PCI — Revascularization Decision (SYNTAX, Heart Team) (CVT)"
aliases: ["CABG vs PCI — Revascularization Decision (SYNTAX, Heart Team) (CVT)", "CABG vs PCI"]
stage: Clerkship
rotation: "Surgery"
...
tags: [workflow]
created: 2026-08-04
notion_id: 3b2224ab-ad81-818a-be97-d26cba08683c
...
**Short Note in CVT — B2 · Ischemic & Valve (SNC-CVT Template A/D: decision).** เพจนี้คือ **decision framework** เลือก CABG vs PCI — SYNTAX score, Heart Team, และ guideline conflict (ESC vs ACC/AHA). ตัว CABG operation เอง → [CABG (Coronary Artery Bypass Grafting) — Surgical Revascularization (CVT)](CABG%20(Coronary%20Artery%20Bypass%20Grafting)%20%E2%80%94%20Surgical%20%203b2224abad81818ca823f54aad5691dc.md) (B1). Disease-side (CCS) → [CCS (Chronic Coronary Syndromes / Chronic Coronary Disease)](CCS%20(Chronic%20Coronary%20Syndromes%20Chronic%20Coronary%20D%203a3224abad8181409b63f8992133584a.md). PCI technique → [CAG & PCI (Coronary Angiography & Percutaneous Intervention)](CAG%20&%20PCI%20(Coronary%20Angiography%20&%20Percutaneous%20Int%203a4224abad81813c812de3765bb742bd.md).
...
- **อย่าเสนอ PCI ใน diabetic multivessel with LAD โดยไม่คุย Heart Team** — CABG (LIMA→LAD) ลด mortality/repeat revasc ชัดเจน (Class IA ทั้ง ESC/ACC-AHA); PCI เฉพาะ very high surgical risk
- **อย่าทำ PCI ใน high SYNTAX (≥33) โดยคิดว่าเทียบเท่า CABG** — MACCE/repeat revasc สูงกว่าชัดเจน; ถ้า complete revasc ด้วย PCI น่าสงสัย → CABG preferred
- **อย่า extrapolate ISCHEMIA มาบอกว่า CABG ไม่ดีกว่า OMT** — ISCHEMIA เปรียบ invasive vs conservative ไม่ได้ randomize CABG โดยตรง (แก่นของ ESC-ACC/AHA conflict)
- **อย่าใช้ anatomic SYNTAX เดี่ยวตัดสินใน borderline case** — มันไม่มี clinical variable + inter-observer variable → ใช้ SYNTAX II + STS + Heart Team
</aside>
...
- **SYNTAX tertile:** ≤22 low (PCI OK) · 23–32 intermediate (Heart Team) · ≥33 high (CABG preferred)
- **SYNTAX II** = anatomic score + age/sex/CrCl/LVEF/LM/PVD/COPD → personalized PCI vs CABG mortality
- **LM low complexity (≤22):** PCI = Class I alternative; LM complex/high: CABG Class I, PCI IIb
- **Diabetes + multivessel + LAD:** CABG (LIMA→LAD) Class IA — ตรงกันทั้ง ESC/ACC-AHA (FREEDOM)
- **Conflict 3VD:** ACC/AHA 2021 downgrade CABG → IIa/IIb (อ้าง ISCHEMIA); ESC 2024 คง Class IA; STS/AATS ไม่ endorse ACC/AHA
- **Heart Team** จำเป็นใน complex case; SYNTAX (IB) + STS (IB) สำหรับ surgical risk
</aside>
...
- 🔍 Verification status
    ...
    **✅ Searched & verified (web, 4 ส.ค. 2026):**
    ...
    - ESC 2024 CCS: LM low (≤22) PCI Class I alternative, LM intermediate PCI IIa, LM+MVD PCI IIb / CABG I; 3VD no DM CABG IA + PCI IA ถ้า low SYNTAX; DM+MVD CABG IA / PCI IIaB; LVEF≤35% CABG IB / PCI IIbB; SYNTAX IB + STS IB (PCRonline ESC 2024; Rev Esp Cardiol; [secce.es](http://secce.es))
    - ACC/AHA 2021 downgrade CABG 3VD → IIa (mild-mod LV dysfx) / IIb (normal LVEF) อ้าง ISCHEMIA; AATS/STS ไม่ endorse; ESC คง Class IA + multisociety STS/EACTS endorse ESC 2024 ([tctmd.com](http://tctmd.com); JTCVS multisociety endorsement 2025)
