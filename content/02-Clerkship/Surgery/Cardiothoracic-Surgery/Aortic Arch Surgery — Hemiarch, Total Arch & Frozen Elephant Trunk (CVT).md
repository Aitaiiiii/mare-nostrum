---
title: "Aortic Arch Surgery — Hemiarch, Total Arch & Frozen Elephant Trunk (CVT)"
aliases: ["Aortic Arch Surgery — Hemiarch, Total Arch & Frozen Elephant Trunk (CVT)", "Aortic Arch Surgery"]
stage: Clerkship
rotation: "Surgery"
...
tags: []
created: 2026-08-04
notion_id: 3b2224ab-ad81-81d5-b0db-f6ea2e341ae0
...
**Short Note in CVT — C4 · Aorta (SNC-CVT Template A/C: procedure).** เพจนี้ครอบ **arch replacement extent + FET** — hemiarch vs total arch, island vs branched, elephant trunk. Temp target/ACP-RCP/circulatory arrest detail → [DHCA & Cerebral Protection (Circulatory Arrest, ACP/RCP, Temperature) (CVT)](DHCA%20&%20Cerebral%20Protection%20(Circulatory%20Arrest,%20AC%203b2224abad818167b51aeb32b07ffea4.md) (A3, ไม่เขียนซ้ำ). Type A → [Acute Type A Aortic Dissection — Surgical Management (CVT)](Acute%20Type%20A%20Aortic%20Dissection%20%E2%80%94%20Surgical%20Manageme%203b1224abad818175be31d2235b4d43b0.md) (C1). FET landing → downstream TEVAR [Type B Aortic Dissection — TEVAR vs Open vs Medical (CVT)](Type%20B%20Aortic%20Dissection%20%E2%80%94%20TEVAR%20vs%20Open%20vs%20Medica%203b2224abad8181e982e7d21e65431204.md) (C2).
...
| หัวข้อ | Hemiarch | Total arch |
| --- | --- | --- |
| Extent | เปลี่ยน lesser curvature ใต้ arch (open distal anastomosis) — ไม่แตะ supra-aortic vessels | เปลี่ยน transverse arch ทั้งหมด + reimplant 3 supra-aortic vessels |
| เมื่อ | tear อยู่ ascending/lesser curvature | tear ที่ greater curvature ใกล้ supra-aortic vessels, arch aneurysm, extensive dissection |
| Circulatory arrest time | สั้นกว่า — morbidity ต่ำกว่า | นานกว่า — stroke/SCI risk สูงกว่า |
...
- **Frozen elephant trunk (FET) — hybrid** — graft ที่มี stent-graft ที่ปลาย deploy antegrade เข้า true lumen ของ descending → **single-stage** + depressurize false lumen → aortic remodeling → ตั้ง landing zone สำหรับ downstream TEVAR (C2)
**TARFET** (Total Arch Replacement using the Frozen Elephant Trunk technique)
...
- **อย่าทำ total arch โดยไม่จำเป็นใน acute dissection** — circulatory arrest นาน → stroke/SCI ↑; hemiarch พอถ้า tear ไม่เข้า arch
- **อย่าใช้ island technique ใน connective tissue disease** — late dilatation ของ island patch; ใช้ branched graft
- **ระวัง spinal cord injury จาก FET stent ยาว** — ครอบ intercostal; จำกัด stent length + spinal protection (C5)
- **อย่าลืม cerebral protection strategy** — arch surgery ต้อง ACP/RCP + temp management (→ A3); circulatory arrest ไม่มี protection → global ischemia
</aside>
...
- **Hemiarch** = lesser curvature, open distal anastomosis, ไม่แตะ supra-aortic — tear ascending/lesser curve
- **Total arch** = transverse arch ทั้งหมด + reimplant 3 vessels — tear greater curve/arch aneurysm
- **Island** (en bloc, เสี่ยง dilatation/bleeding) vs **branched graft** (hemostasis ดี, เหมาะ connective tissue)
- **ET** (2-stage, free graft) vs **FET** (single-stage hybrid stent-graft → remodeling + downstream TEVAR landing); zone 2 anastomosis นิยมขึ้น
- **Cerebral protection** (ACP gold standard, moderate hypothermia) — ดู A3
- **Complication:** stroke ~7%, spinal cord injury ~2–3% (FET stent ยาว), distal SINE, RLN injury
</aside>
