...
> [!tip] Overview hub — every note in **Cardiothoracic Surgery**, grouped by subspecialty. Click the **graph** icon → *local graph* to see how they connect.
