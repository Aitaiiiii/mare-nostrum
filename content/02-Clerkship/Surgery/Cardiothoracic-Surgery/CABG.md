...
aliases: ["CABG (Coronary Artery Bypass Grafting) — Surgical Revascularization (CVT)", "CABG (Coronary Artery Bypass Grafting)", "CABG"]
stage: Clerkship
rotation: "Surgery"
...
**Short Note in CVT — B1 · Ischemic & Valve (SNC-CVT Template A: procedure/operation).** หน้านี้ครอบคลุมเฉพาะ **surgical arm** ของ CABG — conduit choice, on/off-pump, completeness of revascularization, surgical complication และ surgical trial data. Disease-side (CCS pathophysiology, ischemia workup, medical therapy) อยู่ที่ [[CCS (Chronic Coronary Syndromes)|CCS (Chronic Coronary Syndromes / Chronic Coronary Disease)]]. **CABG vs PCI decision + SYNTAX score selection** เป็นหน้าที่ของ B2 (SNC6-CAG/PCI) — ที่นี่แตะเฉพาะเท่าที่ trial ฝั่ง surgery พูด ไม่ทำ decision ladder ซ้ำ. Angiographic technique/lesion assessment อยู่ที่ [[CAG & PCI]].
