---
title: "Type B Aortic Dissection — TEVAR vs Open vs Medical (CVT)"
aliases: ["Type B Aortic Dissection — TEVAR vs Open vs Medical (CVT)", "Type B Aortic Dissection"]
stage: Clerkship
rotation: "Surgery"
...
created: 2026-08-04
notion_id: 3b2224ab-ad81-81e9-82e7-d21e65431204
...
**Short Note in CVT — C2 · Aorta (SNC-CVT Template B/D: decision).** เพจนี้ครอบ **management decision ของ Type B dissection** — medical vs TEVAR vs open + operative concept. Aortic syndrome classification/pathophysiology → [Acute Aortic Syndrome (AAS)](Acute%20Aortic%20Syndrome%20(AAS)%203a3224abad818117a02cd0341b321322.md). Type A → [Acute Type A Aortic Dissection — Surgical Management (CVT)](Acute%20Type%20A%20Aortic%20Dissection%20%E2%80%94%20Surgical%20Manageme%203b1224abad818175be31d2235b4d43b0.md) (C1). BP control acute → [Hypertensive Crises (Emergency & PSH)](Hypertensive%20Crises%20(Emergency%20&%20PSH)%203a9224abad8181b997d6f72f53a120be.md).
...
- **EACTS/STS 2024** — **เลี่ยงคำว่า "uncomplicated"** และจัดกลุ่มตาม risk/symptom แทน — มองว่าคำนี้ heterogeneous เกินไป (เพราะ dissection เปลี่ยนได้ตลอด) — เน้น serial imaging ก่อน escalate
...
- **อย่าให้ vasodilator ก่อน beta-blocker ใน dissection** — reflex tachycardia → เพิ่ม dP/dt → dissection extension; ต้อง rate control ก่อน
- **อย่าพลาด malperfusion** — mesenteric/renal/limb ischemia = complicated → intervention ด่วน; mortality complicated 20% day-2
- **อย่า TEVAR ใน hyperacute โดยไม่จำเป็น** — aorta เปราะ→ retrograde Type A/rupture; subacute remodel ดีกว่า
- **อย่า TEVAR ใน connective tissue disease โดยไม่คิด** — SINE/further dissection; open เป็นหลัก (Marfan/LDS)
- **ระวัง spinal cord ischemia หลัง TEVAR ครอบยาว** — เสี่ยง paraplegia; เตรียม CSF drain
</aside>
...
- **Type B = medical ก่อน** (uncomplicated) — ไม่ใช่ surgical emergency แบบ Type A
- **Complicated** (rupture/malperfusion/extension/refractory pain-HTN) → intervention; **TEVAR > open** (COR I rupture)
- **High-risk uncomplicated** (descending ≥40 mm, entry tear ≥10 mm, persistent pain) → pre-emptive TEVAR (INSTEAD-XL)
- **Medical:** beta-blocker ก่อน (anti-impulse, HR <60) → vasodilator, SBP 100–120
- **TEVAR concept:** ครอบ entry tear → depressurize false lumen → remodeling; subacute timing ดีกว่า hyperacute
- **Conflict:** ACC/AHA uncomplicated/complicated + flexibility; EACTS 2024 เลี่ยงคำ uncomplicated, จัดตาม risk/symptom
- **Mortality:** uncomplicated 30-day 10%; complicated 20% day-2, 25% day-30
</aside>
