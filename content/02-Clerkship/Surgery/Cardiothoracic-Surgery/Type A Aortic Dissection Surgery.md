...
**Short Note in CVT — C1 · Aorta (Template B: disease จบด้วย surgery).** หน้านี้ครอบคลุมเฉพาะ **surgical decision + operative concept + operative outcome** ของ acute type A aortic dissection (ATAAD). Disease-side (pathophysiology, Stanford/DeBakey classification, CTA, anti-impulse therapy, aneurysm threshold) อยู่ที่ [[Acute Aortic Syndrome (AAS)]] ไม่เขียนซ้ำที่นี่. Perioperative physiology (temp target, flow, ACT, cannulation detail) link ไป A3 DHCA & Cerebral Protection.
