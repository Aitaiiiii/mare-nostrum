...
**Short Note in CVT — C4 · Aorta (SNC-CVT Template A/C: procedure).** เพจนี้ครอบ **arch replacement extent + FET** — hemiarch vs total arch, island vs branched, elephant trunk. Temp target/ACP-RCP/circulatory arrest detail → [[DHCA & Cerebral Protection|DHCA & Cerebral Protection (Circulatory Arrest, ACP/RCP, Temperature) (CVT)]] (A3, ไม่เขียนซ้ำ). Type A → [[Type A Aortic Dissection Surgery]] (C1). FET landing → downstream TEVAR [[Type B Aortic Dissection]] (C2).
