---
title: "Tricuspid Valve Surgery — Concomitant & Isolated TR (CVT)"
aliases: ["Tricuspid Valve Surgery — Concomitant & Isolated TR (CVT)", "Tricuspid Valve Surgery"]
stage: Clerkship
rotation: "Surgery"
...
guidelines: ["ESC"]
review_status: "New"
tags: [cardiothoracic-surgery, discrete-entity, esc]
created: 2026-08-04
notion_id: 3b2224ab-ad81-81f4-be23-c2f60bc6b905
...
**Short Note in CVT — B7 · Ischemic & Valve (SNC-CVT Template B: disease→surgery).** เพจนี้ครอบ **surgical decision + operative technique** ของ TV — concomitant TR threshold, isolated TR surgery, annuloplasty. TR pathophysiology/ventricular interdependence/TRILUMINATE → [TR (Tricuspid Regurgitation) — The Forgotten Valve, Ventricular Interdependence & TRILUMINATE](TR%20(Tricuspid%20Regurgitation)%20%E2%80%94%20The%20Forgotten%20Valve%203a0224abad8181938228d555b008509b.md). Transcatheter T-TEER/TTVR → [Transcatheter Mitral & Tricuspid Therapies — M-TEER, T-TEER & TTVR](Transcatheter%20Mitral%20&%20Tricuspid%20Therapies%20%E2%80%94%20M-TEE%203a0224abad8181879a48c742b224dea1.md).
...
- **อย่าละเลย TR ขณะทำ left-sided surgery** — annular dilation >40 mm แม้ไม่มี severe TR ก็ควรทำ annuloplasty (Class IIa); รอให้ progress → reoperation mortality สูง
- **อย่าปล่อย isolated TR จน RV fail แล้วค่อยผ่าตัด** — RV/end-organ dysfunction → operative mortality สูงขึ้นมาก; timing ก่อน RV เสียถาวร
- **อย่าใช้ De Vega เมื่อ annulus dilate มาก** — recurrent TR สูงกว่า ring; ใช้ rigid/3D ring
- **ระวัง mechanical valve ที่ tricuspid** — low-pressure/low-flow → thrombosis สูง; ใช้ bioprosthetic
</aside>
...
- **Forgotten valve** — isolated TR ทนยาน แต่ late severe TR → RV failure; จัดการตอน left-sided surgery ดีที่สุด
- **Concomitant:** moderate/severe FTR → TV repair Class I B; **annular >40 mm แม้ไม่ severe → Class IIa B**
- **Isolated TR reoperation** = high-risk (mortality สูง); minimally invasive/transcatheter เป็นทางเลือก
- **Technique:** ring annuloplasty (durable) > De Vega suture (recurrence สูง); replace เมื่อ tethering รุนแรง → bioprosthetic
- **Recurrence predictor:** LVEF <50%, annulus >40 mm, De Vega, new left-sided lesion
</aside>
