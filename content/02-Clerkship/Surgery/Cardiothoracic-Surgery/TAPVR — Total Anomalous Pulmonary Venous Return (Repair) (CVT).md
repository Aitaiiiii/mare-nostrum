---
title: "TAPVR — Total Anomalous Pulmonary Venous Return (Repair) (CVT)"
aliases: ["TAPVR — Total Anomalous Pulmonary Venous Return (Repair) (CVT)", "TAPVR"]
stage: Clerkship
rotation: "Surgery"
...
tags: []
created: 2026-08-05
notion_id: 3b3224ab-ad81-81f0-b142-e0d910f7afa0
...
**Short Note in CVT — D7 · Congenital (SNC-CVT Template B/D: lesion→surgery).** TAPVR — anatomy, obstruction physiology, surgical urgency, repair. General congenital operations (BTT/PAB/PGE1) → [Congenital Heart Surgery (Common Operations — Palliative, Single-Ventricle Staged & Biventricular Repairs)](Congenital%20Heart%20Surgery%20(Common%20Operations%20%E2%80%94%20Pall%20396224abad8181e4abb5ffb90d579e75.md). Segmental approach → [General Congenital Heart Disease — Approach & Classification](General%20Congenital%20Heart%20Disease%20%E2%80%94%20Approach%20&%20Clas%203a4224abad81813bb714e36339833656.md).
...
| Type | Drainage | ความถี่ + obstruction |
| --- | --- | --- |
| **I Supracardiac** | vertical vein → innominate/SVC | ~40–45% (พบมากสุด); obstruction ได้ (vertical vein ถูกบีบระหว่าง LPA-หลอดลม) |
| **II Cardiac** | coronary sinus หรือ RA โดยตรง | ~20–30%; obstruction พบน้อยสุด (มักไม่ emergency) |
| **III Infracardiac** | descending vein ผ่าน diaphragm → portal/IVC | ~10–30%; **obstruction เสมอ** (เลือดต้องผ่าน hepatic sinusoids) → emergency เสมอ |
| **IV Mixed** | หลายทิศทางรวมกัน | ~5%; repair ยากที่สุด |
...
- **อย่าวินิจฉัย obstructed TAPVR ผิดเป็น PPHN/RDS** — cyanosis + pulmonary edema ไม่ตอบ O₂ = TAPVR obstruction; iNO/vasodilator ทำให้แย่ลง → surgery ด่วน
- **อย่ารอใน infracardiac (Type III)** — obstruction เสมอ → surgical emergency ทุกราย
- **อย่าลืม restrictive ASD** — ถ้า ASD เล็ก → low CO; อาจต้อง balloon septostomy bridge
- **ระวัง post-op PV stenosis** — intrinsic venitis ทำนายยาก; ติดตาม PV velocity ตลอด; sutureless ลดความเสี่ยง
</aside>
...
- **TAPVR** = pulmonary veins → systemic venous/RA; obligate ASD + admixture; ตัวตัดสิน = obstruction หรือไม่
- **Darling:** I supracardiac (~45%, vertical vein→SVC) · II cardiac (coronary sinus) · III infracardiac (**obstruction เสมอ**) · IV mixed
- **Obstructed = surgical emergency** — cyanosis + pulmonary edema ไม่ตอบ O₂; CXR snowman (supracardiac non-obstructed) vs small heart + edema (obstructed)
- **Repair:** confluence→LA anastomosis + ปิด ASD; sutureless pericardial ลด recurrent PV stenosis
- **Post-op PV stenosis** = intrinsic venitis, กำหนด prognosis, morbidity/mortality สูง
- **iNO ทำให้ obstructed TAPVR แย่ลง** (แยกจาก PPHN จริง)
</aside>
...
- 🔍 Verification status
    ...
    **✅ Searched & verified (web, 26 ส.ค. 2026 — lifespan arm):**
    ...
    - Unobstructed — heart failure จาก overcirculation · ราวครึ่งมาในเดือนแรก ที่เหลือภายในขวบปี · heart failure ส่วนใหญ่ภายใน 6 เดือน ([pedecho.org](http://pedecho.org), MSD Manual 2023)
    ...
    **✅ Searched & verified (web, 4 ส.ค. 2026):**
    ...
    - Darling classification (supracardiac ~40–45%, cardiac ~20–30%, infracardiac ~10–30%, mixed ~5%); infracardiac obstruction เสมอ (ผ่าน hepatic sinusoids); supracardiac obstruction ได้ (vertical vein ระหว่าง LPA-bronchus); cardiac มักไม่ obstruct ([mmcts.org](http://mmcts.org) 637; MSD Manual; PMC11180422)
    ...
    - Repair: confluence→LA + ปิด ASD, coronary sinus unroofing (cardiac), sutureless pericardial ลด recurrent obstruction ([mmcts.org](http://mmcts.org); PMC9874290 n=80; PMC4099118)
