---
title: "Sternal Wound Infection & Mediastinitis (Post-Sternotomy) (CVT)"
aliases: ["Sternal Wound Infection & Mediastinitis (Post-Sternotomy) (CVT)"]
stage: Clerkship
rotation: "Surgery"
...
**Short Note in CVT — G3 · Emergencies & complications (SNC-CVT Template A/D: complication).** Sternal wound infection / mediastinitis — ชนิด (SSWI vs DSWI), risk, management ladder. CABG/BITA conduit → [CABG (Coronary Artery Bypass Grafting) — Surgical Revascularization (CVT)](CABG%20(Coronary%20Artery%20Bypass%20Grafting)%20%E2%80%94%20Surgical%20%203b2224abad81818ca823f54aad5691dc.md) (B1). Antibiotic principle → ID pages. Guidelines อ้าง STS (นอก schema) — เว้นว่าง.
...
- **อย่ารอ debride ใน DSWI/mediastinitis** — delay → sepsis/mortality ~2×; สงสัย→reoperation ด่วน
- **อย่าใช้ pedicled BITA ในเบาหวาน** — ลด sternal blood flow → DSWI; skeletonized หรือ single ITA
- **อย่ามองข้าม sternal instability** — sternal click/rocking = dehiscence → สงสัย DSWI
- **อย่าแปล postop mediastinal gas/fluid <2 สัปดาห์ว่า infection** — postop ปกติมีได้; ดู clinical + trend
- **อย่าลืม glycemic control** — hyperglycemia perioperative = ตัวแปรที่ป้องกันได้
</aside>
...
- **SSWI** (skin–fascia, 0.5–8%, mortality ต่ำ) vs **DSWI/mediastinitis** (mediastinum/bone, 0.5–6.8%, **mortality 7–47%**)
- **Risk factor เด่น:** diabetes (insulin), obesity, COPD, renal failure, **BITA harvesting** (↓sternal flow), reop bleeding
- **เชื้อ:** S. aureus/MRSA (พบบ่อย), coagulase-negative staph
- **Management:** early debridement + IV antibiotic (คลุม MRSA) + **VAC** → flap (pectoralis/omental)/sternal plating
- **Prevention:** glycemic control + **skeletonized BITA** + mupirocin carrier + chlorhexidine
- **Pitfall:** sternal click/rocking = dehiscence → สงสัย DSWI; อย่า delay debridement
</aside>
