---
title: "Thoracoabdominal Aortic Aneurysm — Crawford Extent & Spinal Protection (CVT)"
aliases: ["Thoracoabdominal Aortic Aneurysm — Crawford Extent & Spinal Protection (CVT)", "Thoracoabdominal Aortic Aneurysm"]
stage: Clerkship
rotation: "Surgery"
...
tags: []
created: 2026-08-04
notion_id: 3b2224ab-ad81-81a5-87ac-ca70270bfc8a
...
- **อย่าทำ extent II โดยไม่มี spinal protection ครบ** — paraplegia >20% ใน clamp-and-go era; ต้อง CSF drain + DAP + intercostal reimplant
- **อย่าถอด CSF drain เร็วเกินไป** — delayed paraplegia เกิดได้หลังผ่าตัด; continue ≥ 3 วัน + รักษา CSF ≤10 mmHg
- **ระวัง CSF drain complication** — intracranial hypotension/subdural hematoma จาก over-drainage; drain ตาม protocol
- **อย่าละเลย MEP drop ระหว่างผ่าตัด** — เพิ่ม MAP/reattach intercostal ทันที (spinal cord กำลัง ischemia)
- **อย่าลืม renal/visceral protection** — clamp visceral นาน → AKI/bowel ischemia; selective perfusion + cold renal
</aside>
...
- **Crawford:** I (LSA→เหนือ renal) · II (LSA→ใต้ renal, extensiveสุด) · III (T6→renal) · IV (abdominal) · V (T6→เหนือ renal)
- **SCI risk:** extent II สูงสุด ~15% (ถึง 33% สมัย clamp-and-go); I ~4%, IV ~2%
- **Spinal protection (multimodal):** CSF drain (≤10 mmHg, ≥3วัน) + DAP/LHB + sequential clamp + intercostal reimplant (T8–L1) + MEP + moderate hypothermia
- **DAP + CSF** → SCI extent II 33% → <4%
- **Visceral/renal:** selective visceral perfusion + cold renal perfusion
- **Pitfall:** delayed paraplegia → continue CSF drain; MEP drop → เพิ่ม MAP/reattach
</aside>
