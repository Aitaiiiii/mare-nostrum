---
title: "Vasoplegia & Post-CPB Coagulopathy (CVT)"
aliases: ["Vasoplegia & Post-CPB Coagulopathy (CVT)"]
stage: Clerkship
rotation: "Surgery"
specialty: "Cardiothoracic Surgery"
type: "Discrete entity"
guidelines: ["EACTS", "SSC/SCCM"]
review_status: "New"
tags: [cardiothoracic-surgery, discrete-entity, eacts, ssc-sccm]
created: 2026-08-04
...
- **ห้ามให้ methylene blue ในคนที่ได้ serotonergic drug (SSRI/SNRI/MAOI/tramadol)** — MAO-A inhibition → serotonin syndrome; เลือก hydroxocobalamin แทน
- **ห้ามใช้ methylene blue ใน G6PD deficiency** — oxidative hemolysis
- **อย่าเหมารวมทุก hypotension หลัง CPB ว่า vasoplegia** — ต้องดู CI/echo ก่อน; cardiogenic shock (CO ต่ำ) รักษาต่างกัน (inotrope/MCS → A5) การให้ pure vasopressor ใน cardiogenic shock ทำให้แย่ลง
- **อย่าให้ blood product แบบ empiric โดยไม่ POC-guided** — transfusion เกิน เพิ่ม morbidity; แยก surgical bleeding ออกก่อนเสมอ
- **อย่าลืม heparin rebound** — bleeding กลับมาหลัง reversal เรียบร้อย → เช็ค ACT/TEG heparinase → protamine เพิ่ม
</aside>
...
- **Vasoplegia** = MAP <65 + CI >2.2 (low SVR, high/normal CO); mechanism NO/cGMP↑ + vasopressin depletion; risk = preop ACEi/ARB
- **Ladder:** norepinephrine → vasopressin → methylene blue 1.5–2 mg/kg → hydroxocobalamin 5 g → angiotensin II
- **Methylene blue caution:** serotonergic drug (serotonin syndrome) + G6PD (hemolysis) → ใช้ hydroxocobalamin แทน
- **Post-CPB coagulopathy** = multifactorial: hemodilution + platelet dysfunction + fibrinolysis + hypofibrinogenemia (fibrinogen ↓~36%) + heparin/protamine + hypothermia
- **Management = POC-guided (TEG/ROTEM):** protamine (heparin) / fibrinogen (cryo) / platelet / FFP-PCC / TXA; แก้ Ca/temp/pH
- **Pitfall:** แยก vasoplegia vs cardiogenic; แยก surgical vs nonsurgical bleeding; ระวัง heparin rebound
</aside>
