...
- [[Anaphylaxis]]
- [[Approach — The Poisoned Patient]]
- [[Approach — Undifferentiated Shock]]
...
<small>367 notes · live filterable table available in Obsidian (Dataview).</small>
...
```dataview
LIST rows.file.link
FROM "02-Clerkship/Internal-Medicine/Critical-Care"
...
```dataview
LIST file.link
FROM "Standing-Orders/Critical-Care"
