...
- [[Asthma Exacerbation (Acute Severe Asthma)]]
...
<small>356 notes · live filterable table available in Obsidian (Dataview).</small>
...
```dataview
LIST rows.file.link
FROM "02-Clerkship/Internal-Medicine/Pulmonology"
...
```dataview
LIST file.link
FROM "Standing-Orders/Pulmonology"
